...
export default function Post({post}: PostProps ) {
    ...
    const genreName = genres.find((g: { _id: string; name: string }) => g._id === post.genre)?.name;
    const locations = useQuery(api.locations.getLocations, {}) || [];
    const locationName = locations.find((l: { _id: string; name: string }) => l._id === post.location)?.name;
    ...
    return (
        <View style={styles.post}>
            ...
            {/* LOCATION AND GENRE */}
            {(locationName || genreName) && (
                <View style={styles.metaInfo}>
                    {locationName && (
                        <Text style={styles.metaText}>
                            <Text style={styles.metaLabel}>Location: </Text>{locationName}
                        </Text>
                    )}
                {genreName && (
                    <Text style={styles.metaText}>
                        <Text style={styles.metaLabel}>Genre: </Text>{genreName}
                    </Text>
                    )}
                </View>
            )}
